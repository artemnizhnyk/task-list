...
values (nextval('users_id_seq'), 'Artem Nizhnyk', 'artem@gmail.com',
        '$2a$12$LjwUO4iEMm8OvysL0K2E.u32PLe6HILuvkkub6pBIMDyiqIFuAIju', 'ROLE_USER'),
       (nextval('users_id_seq'), 'Any Any', 'any@gmail.com',
        '$2a$12$ka45EqjF6LLi./tAIVg1UOr3T09.5asve3FAFopV4hjtdxKy6ZT3e', 'ROLE_USER');
